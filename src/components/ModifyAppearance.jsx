...
export default function ModifyAppearance({
    ...
    return (
        <section
            ...
            className="mt-20 grid *:text-sm rounded md:grid-cols-4 lg:grid-cols-7 grid-cols-2  gap-4  justify-items-center  *:rounded  items-center justify-center  w-full *:tracking-widest  *:border *:border-[#4b4b4b] *:shadow *:flex-1 *:w-40 *:h-20 *:flex *:items-center *:justify-center *:flex-col  *:space-y-2"
        >
